-- Update match_thoughts to use halfvec casts so queries hit the new halfvec HNSW index
...
BEGIN
  ...
  SELECT
    ...
    (1 - (t.embedding::halfvec(768) <=> query_embedding::halfvec(768)))::float AS similarity,
