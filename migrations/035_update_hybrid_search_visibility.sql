-- Phase 9b: Add visibility filtering to hybrid_search()
-- filter_visibility: text[] of tags the user can see. NULL = no filtering (system/owner).
-- Uses && (array overlap) operator: thought is visible if ANY tag matches.
...
BEGIN
  ...
  WITH vector_results AS (
    ...
    WHERE t.embedding IS NOT NULL
      ...
      AND (filter_visibility IS NULL OR t.visibility && filter_visibility)
